...
export const SelectCategories = ({
  ...
  return loading ? (
    ...
    >
      <div className="flex flex-col w-1/3 md:w-1/3 sm:w-full sm:mx-12 xs:mx-0 sm:hidden">
        <CategoryLink
          title="all"
      ...
      <div className="flex justify-center items-center w-2/3 md:mt-4 px-8 md:w-2/3 sm:w-full">
        <img
          ...
          alt=""
          className="mx-4 w-full md:w-3/4 sm:w-full"
        />
      </div>
    </div>
  );
